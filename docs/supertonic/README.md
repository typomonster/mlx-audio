...
> The `Play` column embeds audio-only MP4s (AAC) — GitHub renders `<video>` tags inline but strips `<audio>` tags, so the MP4 container is what makes the play button show up.
...
| ----- | ----- | ---- | ------ |
| `"Hello world."`                     | M1 | en | [🎧 short_en_M1.wav](https://github.com/typomonster/mlx-audio/raw/main/docs/supertonic/short_en_M1.wav) |
| `"오늘 아침 공원을 산책했어요."`     | F1 | ko | [🎧 short_ko_F1.wav](https://github.com/typomonster/mlx-audio/raw/main/docs/supertonic/short_ko_F1.wav) |
